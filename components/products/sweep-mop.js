...
export default function SweepMop() {
    return (
    ...
    <Fade bottom>
        ...
        <div className="pr_list ">
            <div className="price_item">
                <div className="pr_title">Sweep & Mop</div>
                <div className="price f_700 f_size_40 t_color2">$45.00
                <sub className="f_size_16 f_400"><br />room</sub></div>
                <div className="mt-3 margin-auto">
                  <button class="snipcart-add-item btn_three"
                      data-item-id="sweep-mop"
