...
export default function VentDegreasing() {
    return (
    ...
    <Fade bottom>
        ...
        <div className="pr_list ">
            <div className="price_item">
                <div className="pr_title">Vent Degreasing</div>
                <div className="price f_700 f_size_40 t_color2">$40.00
                <sub className="f_size_16 f_400"><br />service</sub></div>
                <div className="mt-3 margin-auto">
                  <button class="snipcart-add-item btn_three"
                      data-item-id="vent-degreasing"
                      ...
                      data-item-name="Vent Degreasing">
                      Add to cart
                  </button> 
                </div>
            </div>
