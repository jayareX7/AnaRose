...
import Startupsitem from '../components/home-startItems';
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="stratup_service_img">
                                ...
                                <img className="laptop_img" src='assets/img/new/laptop.png' alt=""/>
                                <img className="phone_img" src='assets/img/new/phone.png' alt=""/>
                            </div>
                        </div>
